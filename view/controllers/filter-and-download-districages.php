...
die($region);
    ...
    if (($startDate != "" || $endDate != "") && $region != "") 
    {
        ...
        $statement =  $connect->query("SELECT * FROM voter_response WHERE district = '$region' AND (age BETWEEN '$agefrom' AND '$ageto') AND (DATE(updated_at) BETWEEN '$startDate' AND '$endDate' ) ORDER BY updated_at DESC");
        $statement->execute();
    ...
    } else if (($startDate == "" && $endDate == "") && $region != "") 
    {
        ...
        $statement =  $connect->query("SELECT * FROM voter_response WHERE district = '$region' AND (age BETWEEN '$agefrom' AND '$ageto')  ORDER BY updated_at DESC");
        $statement->execute();
        $results = $statement->fetchAll();
    ...
    } else if (($startDate != "" && $endDate != "") && $region == "") 
    {
        ...
        if ($results) 
        {
            ...
            $filename = "agegroupRecordsOF-$startDate-TO-$endDate.csv";
        ...
        if ($results) 
        {
            ...
            $filename = "alldistrictsagegroupRecord-$regionage.csv";
