...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
    ...
    $regiongender = $_GET['regiongender'];
    $district  = "";
    ...
    if (($startDate != "" || $endDate != "") && $region != "") 
    {
        ...
        $statement =  $connect->query("SELECT * FROM voter_response WHERE region = '$region' AND gender = '$regiongender' AND (DATE(updated_at) BETWEEN '$startDate' AND '$endDate' ) ORDER BY updated_at DESC");
        $statement->execute();
    ...
    } else if (($startDate == "" && $endDate == "") && $region != "") 
    {
        ...
        $statement =  $connect->query("SELECT * FROM voter_response WHERE region = '$region' AND gender = '$regiongender' ORDER BY updated_at DESC");
        $statement->execute();
        $results = $statement->fetchAll();
