...
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS FOR GREATER ACCRA REGION</h3>
                <ol class="breadcrumb">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS BY DISTRICTS WITHIN GREATER ACCRA REGION</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="dashboard"><i class="la la-home font-20"></i></a>
                    </li>
...
<script >
	...
	$(document).ready(function(){
        ...
        // {
	        ...
	        {
	            $.get("controllers/get-accra-record.php", function(response) 
	            {
	                if (response.success) {
	                    var template = ``;
	                    var counter = 1;
