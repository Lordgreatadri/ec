...
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS FOR NORTH EAST REGION</h3>
                <ol class="breadcrumb">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS BY DISTRICTS WITHIN NORTH EAST REGION</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="dashboard"><i class="la la-home font-20"></i></a>
                    </li>
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">All Districts Within North East</div>
                    </div>
...
<script >
    ...
    $(document).ready(function(){
        ...
        // {
            ...
            {
                $.get("controllers/get-north-east-record.php", function(response) 
                {
                    if (response.success) {
                        var template = ``;
                        var counter = 1;
