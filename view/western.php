...
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS FOR WESTERN REGION</h3>
                <ol class="breadcrumb">
            ...
            <div class="page-heading">
                <h3 class="page-title">RECORDS BY DISTRICTS WITHIN WESTERN REGION</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="dashboard"><i class="la la-home font-20"></i></a>
                    </li>
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">All Districts Within Western Region</div>
                    </div>
...
<script >
    ...
    $(document).ready(function(){
        ...
        // {
            ...
            {
                $.get("controllers/get-western-record.php", function(response) 
                {
                    if (response.success) {
                        var template = ``;
                        var counter = 1;
